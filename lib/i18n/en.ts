export const en = {
  ...
  share: {
    ...
    shareCardLabel: "Share-ready summary",
    shareCardBadge: "Axis pick",
    shareCardFallback: "Send the verdict and the compared lineup together.",
    sharedKicker: "Shared comparison",
    sharedLead: (product: string) => `This shared result picked ${product}. Re-run the same comparison or make the call with your own context.`,
