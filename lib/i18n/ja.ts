export const ja = {
  ...
  results: {
    ...
    verifyVerified: "公式スペック検証済み",
    verifyPartial: "一部の公式スペックを検証",
    verifyUnverified: "AI整理（未検証）",
    emptyTitle: "比較を始めますか？",
  ...
  timing: {
    ...
    current: "現在",
    average: "平均",
    releaseHint: (label: string, month: string) => `${label} 発売予定: ${month}`,
    buyNowText: "今買うのがおすすめです",
    buyNowSub: "最近の最安値に近いです。これ以上待っても大きく下がる可能性は低いです。",
    waitShortText: "今買っても大きく損はありません",
    waitShortSub: "平均価格帯です。急がなくてよいならセールを待ってもよいです。",
    waitModelText: "少し待つことを検討してください",
    waitModelSub: "現在価格は最安値よりかなり高いです。値下げや新モデル前の在庫整理を狙いましょう。",
    collectingText: "価格履歴を収集中です",
    collectingSub: "毎日価格を集めています。数日後により正確なタイミング判定ができます。",
    iphoneLabel: "次のiPhone",
    iphoneMonth: "毎年9月",
    galaxySLabel: "次のGalaxy S",
    galaxySMonth: "毎年1月",
    galaxyZLabel: "次のGalaxy Z",
    galaxyZMonth: "毎年7月",
    macbookAirLabel: "次のMacBook Air",
    macbookAirMonth: "春（3〜4月）",
    macbookProLabel: "次のMacBook Pro",
    macbookProMonth: "秋（10〜11月）",
    galaxyBookLabel: "次のGalaxy Book",
    galaxyBookMonth: "春（3〜5月）",
    lgGramLabel: "次のLG gram",
    lgGramMonth: "春（1〜3月）",
  },

  context: {
    triggerTitle: "自分の状況に合わせて再分析",
    triggerHint: "用途・予算を伝えると、より正確なおすすめになります",
    headTitle: "自分の状況に合わせて再分析",
    headSub: "選んだ条件を反映しておすすめを再計算します",
    closeAria: "閉じる",
    useCaseLabel: "主な用途",
    budgetLabel: "予算",
    memoLabel: "追加メモ",
    memoOptional: "（任意）",
    memoPlaceholder: "例: バッテリーが一番大事、iPhoneから乗り換えたい",
    submit: "この条件で再分析",
    submitting: "再分析中…",
    errorNeedInput: "用途か予算を選ぶか、メモを入力してください。",
    errorRetry: "再分析中にエラーが発生しました。しばらくしてから再試行してください。",
    errorNetwork: "ネットワークエラーが発生しました。しばらくしてから再試行してください。",
    useCasePrefix: "用途",
    budgetPrefix: "予算",
    useCaseDaily: "日常使い",
    useCaseWork: "仕事・生産性",
    useCaseCreator: "映像・編集",
    useCaseGame: "ゲーム",
    useCaseStudent: "学校・勉強",
    budgetUnder50: "50万未満",
    budget50to100: "50–100万",
    budget100to200: "100–200万",
    budgetOver200: "200万以上",
  },
