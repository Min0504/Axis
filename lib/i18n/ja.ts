export const ja = {
  ...
  share: {
    ...
    shareCardLabel: "共有しやすい要約",
    shareCardBadge: "Axisのおすすめ",
    shareCardFallback: "結論と比較対象をそのまま共有できます。",
    sharedKicker: "共有された比較",
    sharedLead: (product: string) => `${product}をおすすめした結果です。同じ比較をやり直したり、自分の条件で判断し直せます。`,
