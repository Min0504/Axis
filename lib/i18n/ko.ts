export const ko = {
  ...
  share: {
    ...
    shareCardLabel: "공유용 한 줄 요약",
    shareCardBadge: "Axis 추천",
    shareCardFallback: "추천 결과와 비교 구성을 함께 공유할 수 있어요.",
    sharedKicker: "공유된 비교",
    sharedLead: (product: string) => `${product}을(를) 추천한 결과예요. 같은 질문으로 다시 비교하거나 내 상황에 맞게 다시 판단할 수 있어요.`,
