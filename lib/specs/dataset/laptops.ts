...
export const laptops: VerifiedProduct[] = [
  ...
  {
    id: "galaxy-book6-pro-14",
    canonicalName: "갤럭시 북6 프로 14",
    nameEn: "Galaxy Book6 Pro 14",
    aliases: [
      "갤럭시북6 프로", "갤럭시 북6 프로", "갤럭시북6프로", "갤럭시 북6 프로 14", "갤럭시북6 프로 14",
      "galaxy book6 pro", "galaxy book6 pro 14", "갤럭시북6", "갤럭시 북6"
    ],
    category: "laptop",
    country: "KR",
    source: "https://www.samsung.com/us/computers/galaxy-book/galaxy-book6-pro/",
    fetchedAt: "2026-07",
    tier: 1,
    specs: {
      model_name: "Galaxy Book6 Pro 14", os: "Windows 11 Home", cpu: "Intel Core Ultra 7 356H", gpu: "Intel Arc Graphics",
      ram_gb: "16", storage_gb: "512", display_inch: "14", brightness_nits: "400", panel: "OLED (Dynamic AMOLED 2X)",
      resolution: "2880×1800", refresh_hz: "120", weight_g: "1240", battery_wh: "67.18",
      ports: "Thunderbolt 4 ×2, USB-A, HDMI 2.1, headphone", release_date: "2026년"
    }
  },
  {
    id: "galaxy-book6-pro-16",
    canonicalName: "갤럭시 북6 프로 16",
    nameEn: "Galaxy Book6 Pro 16",
    aliases: [
      "갤럭시북6 프로 16", "갤럭시 북6 프로 16", "갤럭시북6프로16", "galaxy book6 pro 16", "북6 프로 16"
    ],
    category: "laptop",
    country: "KR",
    source: "https://www.samsung.com/us/computers/galaxy-book/galaxy-book6-pro/",
    ...
    tier: 1,
    specs: {
      model_name: "Galaxy Book6 Pro 16", os: "Windows 11 Home", cpu: "Intel Core Ultra X7 358H", gpu: "Intel Arc Graphics",
      ram_gb: "32", storage_gb: "1024", display_inch: "16", brightness_nits: "400", panel: "OLED (Dynamic AMOLED 2X)",
      resolution: "2880×1800", refresh_hz: "120", weight_g: "1590", battery_wh: "78.07",
      ports: "Thunderbolt 4 ×2, USB-A, HDMI 2.1, headphone", release_date: "2026년"
    }
  },
